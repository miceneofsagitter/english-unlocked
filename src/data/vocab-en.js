...
const EN_VOCAB = [
  ...
  },
  {
    ...
    "verb": "get + sth",
    "emoji": "📦",
    "it": "ricevere / procurarsi",
    "simple": "a letter, a coffee, groceries...",
    "example_en": "Can you get some water?",
    "example_it": "Puoi prendere dell'acqua?",
    "tags": ["verbi-irregolari", "verb-get"],
    "context_note": "Ricevere (get a letter, get paid) o procurarsi informalmente (get a coffee, get groceries, get a taxi)",
    "concept": "verb_get_obtain"
  },
  {
    "language": "en",
    "type": "verb",
    "verb": "get + adj",
    "emoji": "🔄",
    "it": "diventare (stato o emozione)",
    "simple": "tired, angry, cold, better, nervous...",
    "example_en": "Things get better over time",
    "example_it": "Le cose migliorano col tempo",
    "tags": ["verbi-irregolari", "verb-get"],
    "context_note": "Cambiamento di stato davanti a aggettivo: get tired, get angry, get dark, get cold, get better, get worse, get excited, get nervous, get bored",
    "concept": "verb_get_become"
  },
  {
    "language": "en",
    "type": "verb",
    "verb": "get + p.p.",
    "emoji": "⚡",
    "it": "passivo informale (subire qc)",
    "simple": "fired, hurt, stuck, lost, married...",
    "example_en": "People get paid on Friday",
    "example_it": "La gente viene pagata il venerdì",
    "tags": ["verbi-irregolari", "verb-get"],
    "context_note": "Subire qualcosa: get hurt, get stuck, get lost, get married, get fired, get paid — più parlato di 'be + p.p.'",
    "concept": "verb_get_passive"
  },
  {
    "language": "en",
    "type": "verb",
    "verb": "get to + place",
    "emoji": "📍",
    "it": "arrivare / raggiungere",
    "simple": "get home, get to work, get there",
    "example_en": "How do I get to the hotel?",
    "example_it": "Come si arriva all'hotel?",
    "tags": ["verbi-irregolari", "verb-get"],
    "context_note": "Arrivare a destinazione: get home, get to work, get there. Non si dice 'arrive to', si dice 'get to'",
    "concept": "verb_get_arrive"
  },
  {
    "language": "en",
    "type": "verb",
    "verb": "get sb to do",
    "emoji": "🤝",
    "it": "far fare / convincere qn",
    "simple": "get him to fix it, get her to come",
    "example_en": "I'll get him to fix it",
    "example_it": "Lo farò sistemare da lui",
    "tags": ["verbi-irregolari", "verb-get"],
    "context_note": "Causativo: get + persona + to + verbo. Convincere o far fare qualcosa a qualcuno",
    "concept": "verb_get_causative"
  },
  {
    "language": "en",
    "type": "verb",
    ...
    "emoji": "💡",
    "it": "capire",
    "simple": "Do you get it? / I don't get it",
    "example_en": "I don't get it, sorry",
    "example_it": "Non capisco, scusa",
    "tags": ["verbi-irregolari", "verb-get", "colloquiale"],
    "context_note": "Capire qualcosa di detto o spiegato: 'Do you get what I mean?' — usatissimo in conversazione",
    "concept": "verb_get_understand"
  },
  {
    "language": "en",
    "type": "verb",
    ...
    "emoji": "🗝️",
    "it": "avere / possedere",
    "simple": "I've got, have you got, she's got",
    "example_en": "I have got a problem",
    "example_it": "Ho un problema",
    "tags": ["verbi-irregolari", "verb-get"],
    "context_note": "Have got = have, soprattutto in inglese britannico. 'Have you got time?' = Hai tempo? Contrazione: I've got, she's got",
    "concept": "verb_have_got"
  },
  {
    "language": "en",
    "type": "verb",
    "verb": "get the door",
    "emoji": "📞",
    "it": "rispondere / aprire (porta o telefono)",
    "simple": "I'll get it / Can you get the phone?",
    "example_en": "Can you get the door?",
    "example_it": "Puoi aprire la porta?",
    "tags": ["verbi-irregolari", "verb-get", "colloquiale"],
    "context_note": "'I'll get it' = rispondo io / apro io. Molto comune per telefono e porta",
    "concept": "verb_get_answer"
  },
  {
    "language": "en",
    "type": "verb",
  ...
  // ============================================================
  // BATCH 8 — Attività fisiche outdoor (arrampicata, parcogiochi, trampolino)
  // ============================================================
  { verb: "buckle up", emoji: "🔒", simple: "strap in / fasten", it: "allacciare / chiudere le fibbie", type: "phrasal", language: "en", example_en: "Buckle up your harness before you climb!", example_it: "Allaccia l'imbragatura prima di arrampicarti!", tags: ["bambini", "sicurezza", "arrampicata", "attività"], context_note: "casco, imbragatura, cinghie", concept: "pv_buckle_up" },
  { verb: "clip in", emoji: "🔗", simple: "attach / hook on", it: "agganciare / moschettare", type: "phrasal", language: "en", example_en: "Clip in before you go up — safety first!", example_it: "Aggancia il moschettone prima di salire — prima la sicurezza!", tags: ["bambini", "sicurezza", "arrampicata"], context_note: "", concept: "pv_clip_in" },
  { verb: "reach up", emoji: "🤸", simple: "stretch / extend upward", it: "allungarsi / tendere le braccia in su", type: "phrasal", language: "en", example_en: "Reach up and grab the next hold!", example_it: "Allungati e prendi la presa successiva!", tags: ["bambini", "attività", "arrampicata"], context_note: "", concept: "pv_reach_up" },
  { verb: "hang on", emoji: "✊", simple: "hold tight / grip", it: "tenersi forte / aggrapparsi", type: "phrasal", language: "en", example_en: "Hang on tight — don't let go!", example_it: "Tieniti forte — non mollare!", tags: ["bambini", "sicurezza", "parcogiochi", "arrampicata"], context_note: "", concept: "pv_hang_on" },
  { verb: "take turns", emoji: "🔄", simple: "go one by one", it: "fare a turno", type: "phrasal", language: "en", example_en: "Take turns — one at a time on the trampoline!", example_it: "Fate a turno — uno alla volta sul trampolino!", tags: ["bambini", "attività", "parcogiochi", "trampolino"], context_note: "", concept: "pv_take_turns" },
  { verb: "slide down", emoji: "🛝", simple: "go down the slide", it: "scendere dallo scivolo", type: "phrasal", language: "en", example_en: "Wait at the top, then slide down!", example_it: "Aspetta in cima, poi scendi dallo scivolo!", tags: ["bambini", "attività", "parcogiochi"], context_note: "", concept: "pv_slide_down" },
  { verb: "line up", emoji: "🚶", simple: "queue / get in line", it: "mettersi in fila / fare la coda", type: "phrasal", language: "en", example_en: "Everyone line up here before we start!", example_it: "Tutti in fila qui prima di iniziare!", tags: ["bambini", "attività", "parcogiochi", "trampolino"], context_note: "", concept: "pv_line_up" },
  { verb: "jump off", emoji: "🏃", simple: "leap off / get off", it: "saltare giù / scendere saltando", type: "phrasal", language: "en", example_en: "Don't jump off while someone else is still bouncing.", example_it: "Non saltare giù mentre qualcun altro sta ancora rimbalzando.", tags: ["bambini", "sicurezza", "trampolino"], context_note: "", concept: "pv_jump_off" },
  { verb: "bounce", emoji: "🤸", it: "rimbalzare / saltare", type: "verb", language: "en", example_en: "Bounce with both feet and keep your balance!", example_it: "Rimbalza con entrambi i piedi e tieni l'equilibrio!", tags: ["bambini", "attività", "trampolino"], context_note: "", concept: "verb_bounce" },
  { verb: "land safely", emoji: "🦺", simple: "touch down / land well", it: "atterrare bene / atterrare in sicurezza", type: "phrasal", language: "en", example_en: "Bend your knees when you land safely!", example_it: "Piega le ginocchia quando atterri!", tags: ["bambini", "sicurezza", "trampolino", "arrampicata"], context_note: "", concept: "pv_land_safely" },

  // ============================================================
  // BATCH 9 — Regole parcogiochi (turni, scivolo, fila)
  // ============================================================
  { verb: "one at a time", emoji: "☝️", it: "uno alla volta", type: "colloquial", language: "en", example_en: "One at a time — wait your turn!", example_it: "Uno alla volta — aspetta il tuo turno!", tags: ["bambini", "parcogiochi", "comportamento"], context_note: "scivolo, trampolino, fila", concept: "col_one_at_a_time" },
  { verb: "wait your turn", emoji: "⏳", it: "aspetta il tuo turno", type: "colloquial", language: "en", example_en: "Wait your turn — you'll get there!", example_it: "Aspetta il tuo turno — ci arrivi!", tags: ["bambini", "parcogiochi", "comportamento"], context_note: "", concept: "col_wait_your_turn" },
  { verb: "no climbing up the slide", emoji: "🛝", it: "non salire dallo scivolo", type: "colloquial", language: "en", example_en: "Hey! No climbing up the slide — go around to the steps!", example_it: "Ehi! Non salire dallo scivolo — vai alle scalette!", tags: ["bambini", "parcogiochi", "sicurezza"], context_note: "", concept: "col_no_climbing_slide" },
  { verb: "don't all come down at once", emoji: "🚸", it: "non scendete tutti insieme", type: "colloquial", language: "en", example_en: "Don't all come down at once — one at a time!", example_it: "Non scendete tutti insieme — uno alla volta!", tags: ["bambini", "parcogiochi", "comportamento"], context_note: "", concept: "col_not_all_at_once" },
  { verb: "it's your turn", emoji: "🎯", it: "è il tuo turno", type: "colloquial", language: "en", example_en: "Good news — it's your turn now! Ready?", example_it: "Buone notizie — è il tuo turno adesso! Pronto?", tags: ["bambini", "parcogiochi", "attività"], context_note: "", concept: "col_its_your_turn" },
  { verb: "no pushing!", emoji: "🙅", it: "niente spinte!", type: "colloquial", language: "en", example_en: "No pushing! Hands to yourself.", example_it: "Niente spinte! Le mani a posto.", tags: ["bambini", "parcogiochi", "comportamento", "sicurezza"], context_note: "fila, scivolo, piscina", concept: "col_no_pushing" },
  { verb: "no cutting in line!", emoji: "🚷", it: "non saltare la fila!", type: "colloquial", language: "en", example_en: "No cutting in line — wait like everyone else!", example_it: "Non saltare la fila — aspetta come tutti gli altri!", tags: ["bambini", "parcogiochi", "comportamento"], context_note: "", concept: "col_no_cutting" },
  { verb: "be gentle!", emoji: "🤲", it: "sii delicato/a!", type: "colloquial", language: "en", example_en: "Be gentle — he's smaller than you!", example_it: "Sii delicato — è più piccolo di te!", tags: ["bambini", "comportamento"], context_note: "con bambini più piccoli", concept: "col_be_gentle" },
  { verb: "stay together!", emoji: "🫂", it: "restate insieme!", type: "colloquial", language: "en", example_en: "Stay together — don't wander off!", example_it: "Restate insieme — non allontanatevi!", tags: ["bambini", "spostamenti", "sicurezza"], context_note: "", concept: "col_stay_together" },
  { verb: "come here!", emoji: "👋", it: "vieni qui!", type: "colloquial", language: "en", example_en: "Come here — I need to tell you something!", example_it: "Vieni qui — devo dirti una cosa!", tags: ["bambini", "comportamento", "base"], context_note: "", concept: "col_come_here" },
  { verb: "you have to share!", emoji: "🤝", it: "devi condividere!", type: "colloquial", language: "en", example_en: "You have to share — it's everyone's toy!", example_it: "Devi condividere — è il giocattolo di tutti!", tags: ["bambini", "comportamento"], context_note: "", concept: "col_share" }
];
